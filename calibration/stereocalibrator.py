...
class StereoCalibrator:
    ...
    def stereo_calibrate(self, pair, boards_sampled=20):
        ...
        if paired_point_data is not None:
            ...
            # 假设 img_locs_A, obj_locs_A, img_locs_B, obj_locs_B 是 numpy 数组或列表
            with open('output.txt', 'w') as f:
                f.write("img_locs_A:\n")
                f.write(str(img_locs_A) + "\n\n")

                f.write("obj_locs_A:\n")
                f.write(str(obj_locs_A) + "\n\n")

                f.write("img_locs_B:\n")
                f.write(str(img_locs_B) + "\n\n")

                f.write("obj_locs_B:\n")
                f.write(str(obj_locs_B) + "\n\n")
