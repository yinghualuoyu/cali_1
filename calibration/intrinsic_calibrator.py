...
class IntrinsicCalibrator:
    ...
    def calibrate_camera(self):
        ...
        # logger.info(f"rvecs: {self.rvecs}")
        # logger.info(f"tvecs: {self.tvecs}")
        logger.info(f"calibration_img_loc: {self.calibration_img_loc[0].shape}")
        # logger.info(f"calibration_img_loc.shape: {len(self.calibration_img_loc)}")
